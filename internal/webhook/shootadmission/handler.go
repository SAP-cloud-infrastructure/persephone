...
// The following +api-doc:allow markers define the ShootSpec fields exposed in the
// public Persephone API reference (generated by pipelines/persephone-api-docs in
// cc/kube-secrets). Fields not listed here are auto-injected by this webhook and
// must not be set by customers (provider.type, region, cloudProfile,
// credentialsBindingName, seedSelector, provider.controlPlaneConfig,
